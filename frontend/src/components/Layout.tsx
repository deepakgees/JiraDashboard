...
const Layout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Stories', href: '/stories', icon: ClipboardDocumentListIcon },
    { name: 'Subtasks', href: '/subtasks', icon: ListBulletIcon },
    { name: 'Bugs (New Dev)', href: '/bugs', icon: BugAntIcon },
    { name: 'Sprints', href: '/sprints', icon: CalendarIcon },
  ];

  const settingsNavigation = [
    { name: 'Jira Authentication', href: '/oauth', icon: KeyIcon },
  ];
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              >
                ...
                <span className="hidden sm:inline">Jira Authentication</span>
